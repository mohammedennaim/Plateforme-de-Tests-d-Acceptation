    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <!-- Quiz Info and Score Summary -->
                    <div class="mb-8 bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ $attempt->quiz->title }}</h1>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                            <div class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
                                ...
                                <p class="text-3xl font-bold {{ $attempt->passed ? 'text-green-500' : 'text-red-500' }}">
                            ...
                            <div class="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
                                ...
                                <p class="text-xl font-semibold {{ $attempt->passed ? 'text-green-500' : 'text-red-500' }}">
                        ...
                        @foreach ($attempt->quiz->questions as $question)
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
                                <div class="flex justify-between items-start mb-4">
                                    ...
                                    <span class="px-2 py-1 text-xs font-semibold rounded {{ $isCorrect ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200' }}">
                                ...
                                <div class="space-y-3">
                                    @foreach ($question->options as $option)
                                        <div class="flex items-center p-3 rounded-lg {{ 
                                            ($option->is_correct) ? 'bg-green-50 border border-green-200 dark:bg-green-900/20 dark:border-green-800' : 
                                            (!$option->is_correct && $userAnswerId == $option->id) ? 'bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-800' : 
