<x-app-layout>
    <div class="flex h-screen bg-gray-100 dark:bg-gray-900">
        <!-- Sidebar -->
        <div class="w-64 flex-shrink-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
            <div class="h-full px-3 py-4 overflow-y-auto">
                <div class="text-gray-500 dark:text-gray-400 uppercase text-sm font-semibold mb-4">Navigation</div>
                <ul>
                    <li class="mb-2">
                        <a href="{{ route('dashboard') }}"
                            class="block px-4 py-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200 ease-in-out @if(request()->routeIs('dashboard')) bg-gray-200 dark:bg-gray-700 @endif">
                            Dashboard
                        </a>
                    </li>
                    ...
                    <li class="mt-6 mb-2">
                        <span
                            class="px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Quizzes</span>
                    </li>

                    @forelse($quizzes as $quiz)
                        <li class="mb-2">
                            <a href="{{ route('quiz.questions.index', $quiz->id) }}"
                                class="block px-4 py-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200 ease-in-out 
                                    @if(request()->is('quiz/' . $quiz->id . '/questions*')) bg-gray-200 dark:bg-gray-700 @endif">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm truncate">Questions{{ $quiz->id }}</span>
                                </div>
                            </a>
                        </li>
                    @empty
                        <li class="mb-2 px-4 py-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <li class="mt-6 mb-2">
                        <span
                            class="px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Administration</span>
                    </li>
                    <li class="mb-2">
                        <a href="#"
                            class="block px-4 py-2 rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200 ease-in-out">
                        ...
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                    <!-- Total Students Card -->
                                    <div
                                        class="bg-white dark:bg-gray-700 rounded-lg shadow p-5 border-l-4 border-blue-500">
                                    ...
                                    <div
                                        class="bg-white dark:bg-gray-700 rounded-lg shadow p-5 border-l-4 border-green-500">
                                        <div class="flex justify-between">
                                            <div>
                                    ...
                                    <!-- Total Quizzes Card -->
                                    <div
                                        class="bg-white dark:bg-gray-700 rounded-lg shadow p-5 border-l-4 border-purple-500">
                                        <div class="flex justify-between">
                                            <div>
                                    ...
                                    <!-- Active Staff Card -->
                                    <div
                                        class="bg-white dark:bg-gray-700 rounded-lg shadow p-5 border-l-4 border-yellow-500">
                                        <div class="flex justify-between">
                                            <div>
                                        ...
                                        <tbody
                                            ...
                                            @forelse($quizzes as $quiz)
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm text-gray-500 dark:text-gray-400">
                                                            {{ number_format($quiz->attempts_avg_score, 1) }}%
                                                        </div>
                                                    </td>
    ...
    <div id="quizModal"
        ...
        <div class="bg-white rounded-lg w-full max-w-md p-6">
            ...
            <form id="quizForm" action="{{ route('quizzes.store') }}" method="POST">
                ...
                <div class="mb-4">
                    <label for="duration_minutes" class="block text-sm font-medium text-gray-700">Durée
                        (minutes)</label>
                ...
                <div class="mb-4">
                    <label for="passing_score" class="block text-sm font-medium text-gray-700">Score de réussite
                        (%)</label>
